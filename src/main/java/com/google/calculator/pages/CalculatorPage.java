...
public class CalculatorPage {
    ...
    private static final String SEARCH_BUTTON_XPATH = "(//input[@value='Google Search'])[2]";

    private static final By SEARCH_TEXTBOX_FIELD = By.name("q");
    ...
    public void visitCalculator() {
        ...
        driver.findElement(SEARCH_TEXTBOX_FIELD).sendKeys("Google Calculator");
    ...
    public void clearCalculator() {
        try {
            // Try to click AC button first
            driver.findElement(AC_BUTTON).click();
        } catch (Exception e) {
            // If AC button is not found, try CE button instead
